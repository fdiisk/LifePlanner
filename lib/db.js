...
export async function initDb() {
  ...
  await sql`
    CREATE TABLE IF NOT EXISTS goals (
      ...
      health_metric_type VARCHAR(50),
      star_threshold_2 INTEGER DEFAULT 70,
      star_threshold_3 INTEGER DEFAULT 90,
  ...
  await sql`
    INSERT INTO user_settings (daily_calories_target, daily_protein_target, daily_carbs_target, daily_fats_target)
    SELECT 2000, 150, 200, 65
  ...
  // New unified goal system tables
  await sql`
    CREATE TABLE IF NOT EXISTS goal_contributions (
      ...
      contribution_type VARCHAR(20) DEFAULT 'automatic',
      notes TEXT,
      created_at TIMESTAMP DEFAULT NOW(),
      updated_at TIMESTAMP DEFAULT NOW(),
  ...
  await sql`
    CREATE TABLE IF NOT EXISTS milestones (
      ...
      milestone_type VARCHAR(20) DEFAULT 'quantitative',
      target_value FLOAT,
      target_unit VARCHAR(50),
